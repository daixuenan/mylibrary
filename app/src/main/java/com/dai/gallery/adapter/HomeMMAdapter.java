...
public class HomeMMAdapter extends BaseRecyclerViewAdapter {

    public HomeMMAdapter(Context _ctx, Class cls) {
        super(_ctx, cls);
    }
    ...
    protected void onBindView(BaseRecyclerViewHolder holder, int position) {
        ...
        layoutParams.height = (int) ((Configure.SCREEN_WIDTH - DpPxSpUtils.dip2px(45)) * 0.618 / 2);
